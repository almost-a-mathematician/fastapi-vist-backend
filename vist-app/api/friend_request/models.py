...
class FriendRequest(Model):
    ...
    sender: Mapped[User] = relationship(
        ...
        backref=backref("friend_requests_sent", cascade='all, delete')
    )
    receiver_id: Mapped[int] = mapped_column(ForeignKey('users.id'))
    receiver: Mapped[User] = relationship(
        foreign_keys=receiver_id, 
        backref=backref("friend_request_received", cascade='all, delete')
    )
    ...
    rejected_by: Mapped[User | None] = relationship(
        ...
        backref=backref("friend_requests_rejected", cascade='all, delete')
    )
