...
email_token = TokenManager(secret=os.getenv('EMAIL_TOKEN_SECRET'), lifetime=int(os.getenv('EMAIL_TOKEN_LIFETIME')))

access_token = TokenManager(secret=os.getenv('ACCESS_TOKEN_SECRET'), lifetime=int(os.getenv('ACCESS_TOKEN_LIFETIME')))
